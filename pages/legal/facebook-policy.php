...
<h4 class="text-primary mb-3">Type of Information We Automatically Collect from Users:</h4>
...
<hr class="my-4" />
<h4 class="text-primary mb-3">Type of Information We Might Collect if you have Authorized us to collect is:</h4>
...
<hr class="my-4" />
<h4 class="text-primary mb-3">Who do we share your information with?</h4>
...
<h4 class="text-primary mb-3">Controlling your Data</h4>
...
<hr class="my-4" />
<h4 class="text-primary mb-3">Other Disclosures and Assurances</h4>
<hr class="my-4" />
