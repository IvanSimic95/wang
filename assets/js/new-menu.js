...
function globalNavDropdowns(e) {
  ...
  (this.container = document.querySelector(e)),
    ...
    this.checkCollision(),
    window.addEventListener("load", this.checkCollision.bind(this), {passive: true}),
    window.addEventListener("resize", this.checkCollision.bind(this), {passive: true}),
...
var Strut = {
  ...
  ready: function (e) {
    document.readyState !== "loading"
      ? e()
      : document.addEventListener("DOMContentLoaded", e, {passive: true});
  }
};
(Strut.isRetina = window.devicePixelRatio > 1.3),
  (Strut.mobileViewportWidth = 1200),
