...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item"><a class="nav-link active" id="reviews-tab" data-bs-toggle="tab" href="#tab-reviews" role="tab" aria-controls="tab-reviews" aria-selected="true">Website Reviews</a></li>
  <li class="nav-item"><a class="nav-link" id="trustpilot-tab" data-bs-toggle="tab" href="#tab-trustpilot" role="tab" aria-controls="tab-trustpilot" aria-selected="false">TrustPilot Reviews</a></li>
  <li class="nav-item"><a class="nav-link" id="facebook-tab" data-bs-toggle="tab" href="#tab-facebook" role="tab" aria-controls="tab-facebook" aria-selected="false">Facebook Reviews</a></li>
</ul>
<div class="tab-content border-x border-bottom p-3" id="reviews-tab">
...
echo '<div class="card mb-3 shadow-none item" style="border: 1px solid #dee2e6 !important;">
...
echo '</div><div class="pagination"><a href="https://'.$domain.'/templates/rating/load-review.php?product='.$productID.'&page=1" class="next">Next</a></div>
...
echo '</div><div class="pagination"><a href="https://'.$domain.'/templates/rating/load-review.php?product='.$productID.'&page=1" class="next" style="display:none!important;">Next</a></div>
...
<div class="tab-pane fade" id="tab-trustpilot" role="tabpanel" aria-labelledby="trustpilot-tab">
<div class="elfsight-app-7e9c1668-1e3a-435c-9206-47c962b9418f"></div>  
</div>

<div class="tab-pane fade" id="tab-facebook" role="tabpanel" aria-labelledby="facebook-tab">
<div class="elfsight-app-93d900c3-4303-46a8-817e-629442370619"></div>
</div>
</div>
