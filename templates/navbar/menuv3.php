  ...
  <div class="container-lg">
    <ul class="navRoot">
     ...
     <img class="logo-2" src="/assets/img/master-wang-logo.png" alt="Master Wang Logo #2"> 
      ...
      <!------------------------------- MAIN MENU GROUP ------------------------------>
      <div class="main-menu-group flex-row justify-content-start align-items-center flex-nowrap">
      <li class="navSection nav-item nav-item-menu d-flex">
      <a href="/" class="rootLink"><i class="fas fa-home"></i> Home</a>
      </li>

      <li class="navSection nav-item nav-item-menu dropdown d-flex sub-menu">
      <a class="nav-link dropdown-toggle pe-0" id="navbarDropdownShop" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
      <p class="fs-1 d-inline-block align-middle m-0"><i class="fas fa-shopping-basket"></i> Shop</p></a>

      <div class="dropdown-menu dropdown-menu-card border-0" aria-labelledby="navbarDropdownShop">
      <div class="card navbar-card-app shadow-sm dark__bg-1000">
      ...
      <li class="navSection nav-item nav-item-menu dropdown sub-menu">
<a class="nav-link dropdown-toggle pe-0" id="navbarDropdownSupport" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
<p class="fs-1 d-inline-block align-middle m-0"><i class="fas fa-life-ring"></i> Support</p>
</a>
                  
      <div class="dropdown-menu dropdown-menu-card border-0 py-0" aria-labelledby="navbarDropdownSupport" aria-labelledby="navbarDropdownSupport">
            <div class="bg-white dark__bg-1000 rounded-3 py-2 shadow-sm">
  ...
  <div class="linkGroup documentationGroup">
    <a class="linkContainer withIcon item-documentation" href="/dashboard">
      <h3 class="linkTitle linkIcon"><svg width="17" height="17">
      ...
      <li class="navSection nav-item nav-item-menu dropdown sub-menu">
<a class="nav-link dropdown-toggle pe-0" id="navbarDropdownLegal" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
<p class="fs-1 d-inline-block align-middle m-0"><i class="fa fa-gavel"></i> Legal</p>
</a>
                  
      <div class="dropdown-menu dropdown-menu-card border-0 py-0 legal-dropdown" aria-labelledby="navbarDropdownLegal" aria-labelledby="navbarDropdownLegal">
            <div class="bg-white dark__bg-1000 rounded-3 py-2">


    <div class="linkGroup documentationGroup">
    <a class="linkContainer item-documentation" href="/legal/dmca">
    <h3 class="linkTitle linkIcon">DMCA</h3>
    <span class="linkSub">We respect the intellectual property rights.</span>
    </a>
    </div>
    ...
    <div class="linkGroup documentationGroup">
    <a class="linkContainer item-documentation" href="/legal/privacy-policy">
    <h3 class="linkTitle linkIcon">Privacy Policy</h3>
    <span class="linkSub">How we gather, use and manage client's data.</span>
    </a>
    </div>
    ...
    <div class="linkGroup documentationGroup">
    <a class="linkContainer item-documentation" href="/legal/terms-of-service">
    <h3 class="linkTitle linkIcon">Terms of Service</h3>
    <span class="linkSub">The website and its contents are owned or licensed by the website’s owner</span>
    </a>
    </div>
    ...
    <div class="linkGroup documentationGroup">
    <a class="linkContainer item-documentation" href="/legal/refund-policy">
    <h3 class="linkTitle linkIcon">Refund Policy</h3>
    <span class="linkSub">We offer refunds on purchase of our digital goods.</span>
    </a>
    </div>
    ...
    <div class="linkGroup documentationGroup">
    <a class="linkContainer item-documentation" href="/legal/facebook-policy">
    <h3 class="linkTitle linkIcon">Facebook Policy</h3>
    <span class="linkSub">You may request that we delete any data about you at ay time.</span>
    </a>
    </div>
            </div>
      </div>
...
<li class="navSection nav-item nav-item-menu dropdown sub-menu btn btn-light w-100 p-0">
        ...
        <div class="dropdown-menu dropdown-menu-end py-0 border-0" aria-labelledby="navbarDropdownUser" data-bs-popper="none">
          <div class="bg-white dark__bg-1000 rounded-3 py-2">
            <a class="dropdown-item" style="color:#c828bd !important;text-transform:none;" href="/dashboard" title="User Dashboard"><span><div class="fas fa-box pt-2 me-3"></div> <?php echo $_SESSION['email']; ?></span></a>

            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="/dashboard/orders"><div class="fas fa-box-open pt-2 me-3"></div> My Orders 
                            <?php 
                            ...
                            ?> </a>
            <a class="dropdown-item" href="/dashboard/profile"><div class="fa fa-user-pen pt-2 me-3"></div> Profile &amp; account</a>
            <a class="dropdown-item" href="/dashboard/support"><div class="fa fa-comment-question pt-2 me-3"></div> Live Support</a>

            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="/dashboard?logout=yes"><div class="fa fa-right-from-bracket pt-2 me-3"></div> Logout</a>
    </div>
  </div>
</a>
      </li>
      ...
      <?php }else{ ?>
        ...
        <li class="navSection nav-item nav-item-menu btn btn-light text-uppercase p-2">
          ...
          <div class="avatar avatar-xl align-middle"><img class="rounded-circle" src="/assets/img/default-avatar.jpg" alt="Default Avatar"></div>
        </a>
      </li>
...
<div class="popup">
  <div class="popupContainer">
    <a class="popupCloseButton">Close</a>
      ...
      <div class="card p-0"  style="background-image:url(/assets/img/icons/spot-illustrations/corner-6.png);background-size: cover;repeat:no-repeat;">
      <div class="card-header bg-light p-4 py-3 topbar-gradient">
             <div class="d-flex flex-between-center">
           <h3 class="mb-0 fw-semibold fs-1" style="color:#fff;">Main Menu</h3>
       </div>
      </div>
...
<?php if(isset($_SESSION['id'])){ ?>
  ...
  <div style="padding-left:0.75rem;padding-right:0.75rem;"><button id="contactpopup" class="mt-3 btn btn-dark w-100 rounded-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#contact-popup" aria-controls="#contact-popup">Contact Us!</button></div>
